...
* API key 长这样 `9iGe222G6Vcxxxfs1AgJ`
...
```{r plain pic,echo=FALSE,warning=FALSE}
...
pic_beautiful = pic_cn+theme_economist()

```


## show beautiful picture

```{r beautiful picture,echo=FALSE,,warning=FALSE}
...
* 更多主题，请见https://github.com/jrnold/ggthemes
...
## 找到中国，美国和日本的股市市值占GDP的比重后，
## 把她们放到一起，以便于quandl函数能够获得多个数据
codes = c('WGFD/CHN_GFDD_DM_01',
          'WGFD/USA_GFDD_DM_01',
          'WGFD/JPN_GFDD_DM_01')
...
```{r multiple picture,echo=FALSE,warning=FALSE}
...
pic_stress = pic_compare + theme_economist()+
            annotate('rect',
...
```{r stress picture,echo=FALSE,warning=FALSE}
