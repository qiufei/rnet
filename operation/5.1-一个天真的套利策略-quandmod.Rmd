...
icbc = getSymbols("601398.ss",from = "2014-01-01",to = Sys.Date(),src = "google",auto.assign=FALSE)
...
nb = getSymbols("002142.sz",from = "2014-01-01",to = Sys.Date(),src = "google",auto.assign=FALSE)
